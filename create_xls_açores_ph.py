...
if 'ph' in ds_acores.variables and 'lev' in ds_acores.coords:
    ...
    # Convertir en DataFrame pour l'exportation en Excel
    ph_acores_df = ph_acores_period.to_dataframe().reset_index()
    ph_acores_df.columns = ['Date', 'pH']

    # Enregistrer dans un fichier Excel
    output_file = 'ph_acores_2015_2035.xls'
    ph_acores_df.to_excel(output_file, index=False)
